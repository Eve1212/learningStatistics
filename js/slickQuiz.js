 ...
 * @license MIT
 */
var selectedAnswers = [], trueAnswers = [], preTrueAnswer = [], outputselectedAnswers = [], totalCorrectAnswers = 0, selectedPreAnswer = [], pretestCorrect = 0;
(function($){
    $.slickQuiz = function(element, options) {
        ...
        var quizValues = (plugin.config.json ? plugin.config.json : typeof pretest != 'undefined' ? pretest : null);
        ...
        plugin.method = {
                ...
                for (i in questions) {
                    if (questions.hasOwnProperty(i)) {
                        ...
                        if (plugin.config.backButtonText && plugin.config.backButtonText !== '') {
                            ...
                            questionHTML.append('<div class="divider"/>');
                        }
              ...
              //  var trueAnswers = [];
               ...
               // var selectedAnswers = [];
                answerSelects.each( function() {
                    ...
                    selectedPreAnswer.push(parseInt(id.replace(/(.*\_question\d{1,}_)/, ''), 10));
                });
            ...
            completeQuiz: function(options) {
                ...
                for (i = 0; i < questions.length; i++){
                    if (preTrueAnswer[i] == selectedPreAnswer[i]){
                        totalCorrectAnswers = totalCorrectAnswers + 1;
                        pretestCorrect = pretestCorrect +1;
                       // posttestCorrect = posttestCorrect + 1;
                    }
                }

                var score = pretestCorrect, displayScore = pretestCorrect;
                ...
                $quizArea.fadeOut(300, function() {
                    ...
                    $('#slickQuiz').append("<br>").append(backToGameButton());
                });
               ...
               /* if (selectedAnswers.length == NumberOfPretestQuestions){
